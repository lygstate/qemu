    ...
    CPU_FOREACH(cpu) {
        ...
        if (x64) {
            ctx.x64 = (WinContext64){
                ...
                .Rcx = target_ulong_array_val(&env->regs.rec, R_ECX),
                .Rdx = target_ulong_array_val(&env->regs.rec, R_EDX),
                .Rsp = target_ulong_array_val(&env->regs.rec, R_ESP),
                .Rbp = target_ulong_array_val(&env->regs.rec, R_EBP),
                .Rsi = target_ulong_array_val(&env->regs.rec, R_ESI),
                .Rdi = target_ulong_array_val(&env->regs.rec, R_EDI),
                .R8  = target_ulong_array_val(&env->regs.rec, 8),
                .R9  = target_ulong_array_val(&env->regs.rec, 9),
                .R10 = target_ulong_array_val(&env->regs.rec, 10),
                .R11 = target_ulong_array_val(&env->regs.rec, 11),
                .R12 = target_ulong_array_val(&env->regs.rec, 12),
                .R13 = target_ulong_array_val(&env->regs.rec, 13),
            ...
            ctx.x32 = (WinContext32){
                ...
                .Ecx = target_ulong_array_val(&env->regs.rec, R_ECX),
                .Edx = target_ulong_array_val(&env->regs.rec, R_EDX),
                .Esp = target_ulong_array_val(&env->regs.rec, R_ESP),
                .Ebp = target_ulong_array_val(&env->regs.rec, R_EBP),
