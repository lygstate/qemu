...
static const VMStateField vmstate_tc_fields[] = {
    VMSTATE_UINT32_ARRAY_AVAILABLE(gpr.u32, TCState, 32,
                                   target_is_long_bits_32),
    VMSTATE_UINT64_ARRAY_AVAILABLE(gpr.u64, TCState, 32,
                                   target_is_long_bits_64),
#if defined(TARGET_MIPS64)
    VMSTATE_UINT64_ARRAY(gpr_hi, TCState, 32),
#endif /* TARGET_MIPS64 */
    VMSTATE_UINT32_AVAILABLE(PC.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(PC.u64, TCState, target_is_long_bits_64),
    VMSTATE_UINT32_ARRAY_AVAILABLE(HI.u32, TCState, MIPS_DSP_ACC,
                                   target_is_long_bits_32),
    VMSTATE_UINT64_ARRAY_AVAILABLE(HI.u64, TCState, MIPS_DSP_ACC,
                                   target_is_long_bits_64),
    VMSTATE_UINT32_ARRAY_AVAILABLE(LO.u32, TCState, MIPS_DSP_ACC,
                                   target_is_long_bits_32),
    VMSTATE_UINT64_ARRAY_AVAILABLE(LO.u64, TCState, MIPS_DSP_ACC,
                                   target_is_long_bits_64),
    VMSTATE_UINT32_ARRAY_AVAILABLE(ACX.u32, TCState, MIPS_DSP_ACC,
                                   target_is_long_bits_32),
    VMSTATE_UINT64_ARRAY_AVAILABLE(ACX.u64, TCState, MIPS_DSP_ACC,
                                   target_is_long_bits_64),
    VMSTATE_UINT32_AVAILABLE(DSPControl.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(DSPControl.u64, TCState, target_is_long_bits_64),
    VMSTATE_INT32(CP0_TCStatus, TCState),
    VMSTATE_INT32(CP0_TCBind, TCState),
    VMSTATE_UINT32_AVAILABLE(CP0_TCHalt.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(CP0_TCHalt.u64, TCState, target_is_long_bits_64),
    VMSTATE_UINT32_AVAILABLE(CP0_TCContext.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(CP0_TCContext.u64, TCState, target_is_long_bits_64),
    VMSTATE_UINT32_AVAILABLE(CP0_TCSchedule.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(CP0_TCSchedule.u64, TCState, target_is_long_bits_64),
    VMSTATE_UINT32_AVAILABLE(CP0_TCScheFBack.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(CP0_TCScheFBack.u64, TCState, target_is_long_bits_64),
    VMSTATE_INT32(CP0_Debug_tcstatus, TCState),
    VMSTATE_UINT32_AVAILABLE(CP0_UserLocal.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(CP0_UserLocal.u64, TCState, target_is_long_bits_64),
    VMSTATE_INT32(msacsr, TCState),
    VMSTATE_UINT32_ARRAY_AVAILABLE(mxu_gpr.u32, TCState, NUMBER_OF_MXU_REGISTERS - 1,
                                   target_is_long_bits_32),
    VMSTATE_UINT64_ARRAY_AVAILABLE(mxu_gpr.u64, TCState, NUMBER_OF_MXU_REGISTERS - 1,
                                   target_is_long_bits_64),
    VMSTATE_UINT32_AVAILABLE(mxu_cr.u32, TCState, target_is_long_bits_32),
    VMSTATE_UINT64_AVAILABLE(mxu_cr.u64, TCState, target_is_long_bits_64),
    VMSTATE_END_OF_LIST()
};
...
const VMStateDescription vmstate_mips_cpu = {
    ...
    .fields = (const VMStateField[]) {
        ...
        VMSTATE_UINT32_AVAILABLE(env.btarget.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.btarget.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.bcond.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.bcond.u64, MIPSCPU, target_is_long_bits_64),
        ...
        VMSTATE_UINT32_AVAILABLE(env.CP0_YQMask.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_YQMask.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_VPESchedule.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_VPESchedule.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_VPEScheFBack.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_VPEScheFBack.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_INT32(env.CP0_VPEOpt, MIPSCPU),
        VMSTATE_UINT64(env.CP0_EntryLo0, MIPSCPU),
        VMSTATE_UINT64(env.CP0_EntryLo1, MIPSCPU),
        VMSTATE_INT32(env.CP0_GlobalNumber, MIPSCPU),
        VMSTATE_UINT32_AVAILABLE(env.CP0_Context.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_Context.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_INT32(env.CP0_MemoryMapID, MIPSCPU),
        VMSTATE_INT32(env.CP0_PageMask, MIPSCPU),
        VMSTATE_INT32(env.CP0_PageGrain, MIPSCPU),
        VMSTATE_UINT32_AVAILABLE(env.CP0_SegCtl0.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_SegCtl0.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_SegCtl1.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_SegCtl1.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_SegCtl2.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_SegCtl2.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_PWBase.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_PWBase.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_PWField.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_PWField.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_PWSize.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_PWSize.u64, MIPSCPU, target_is_long_bits_64),
        ...
        VMSTATE_UINT32_AVAILABLE(env.CP0_BadVAddr.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_BadVAddr.u64, MIPSCPU, target_is_long_bits_64),
        ...
        VMSTATE_UINT32_AVAILABLE(env.CP0_EntryHi.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_EntryHi.u64, MIPSCPU, target_is_long_bits_64),
        ...
        VMSTATE_UINT32_AVAILABLE(env.CP0_EPC.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_EPC.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_INT32(env.CP0_PRid, MIPSCPU),
        VMSTATE_UINT32_AVAILABLE(env.CP0_EBase.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_EBase.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_AVAILABLE(env.CP0_CMGCRBase.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_CMGCRBase.u64, MIPSCPU, target_is_long_bits_64),
        ...
        VMSTATE_UINT32_AVAILABLE(env.lladdr.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.lladdr.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_UINT32_ARRAY_AVAILABLE(env.CP0_WatchLo.u32, MIPSCPU, 8,
                                       target_is_long_bits_32),
        VMSTATE_UINT64_ARRAY_AVAILABLE(env.CP0_WatchLo.u64, MIPSCPU, 8,
                                       target_is_long_bits_64),
        VMSTATE_UINT64_ARRAY(env.CP0_WatchHi, MIPSCPU, 8),
        VMSTATE_UINT32_AVAILABLE(env.CP0_XContext.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_XContext.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_INT32(env.CP0_Framemask, MIPSCPU),
        VMSTATE_INT32(env.CP0_Debug, MIPSCPU),
        VMSTATE_UINT32_AVAILABLE(env.CP0_DEPC.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_DEPC.u64, MIPSCPU, target_is_long_bits_64),
        ...
        VMSTATE_UINT32_AVAILABLE(env.CP0_ErrorEPC.u32, MIPSCPU, target_is_long_bits_32),
        VMSTATE_UINT64_AVAILABLE(env.CP0_ErrorEPC.u64, MIPSCPU, target_is_long_bits_64),
        VMSTATE_INT32(env.CP0_DESAVE, MIPSCPU),
        VMSTATE_UINT32_ARRAY_AVAILABLE(env.CP0_KScratch.u32, MIPSCPU, MIPS_KSCRATCH_NUM,
                                       target_is_long_bits_32),
        VMSTATE_UINT64_ARRAY_AVAILABLE(env.CP0_KScratch.u64, MIPSCPU, MIPS_KSCRATCH_NUM,
                                       target_is_long_bits_64),
