/*
 * 64-bit TCGv aliases for RISC-V TCG compiled into libsystem_riscv.
 * TARGET_LONG_BITS is poisoned in that compile, so tcg/tcg-op.h cannot
 * be included. Guest XLEN is selected at runtime via DisasContext.
 */

#ifndef RISCV_TCG_OP_RISCV_H
#define RISCV_TCG_OP_RISCV_H
